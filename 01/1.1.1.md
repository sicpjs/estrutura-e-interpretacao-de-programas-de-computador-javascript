...
clicando nela, ele responderá exibindo um interpretador JavaScript com a opção de avaliar a instrução pressionando um botão "Run" (Excecutar). Clique na instrução da expressão primitiva e veja o que acontece!
